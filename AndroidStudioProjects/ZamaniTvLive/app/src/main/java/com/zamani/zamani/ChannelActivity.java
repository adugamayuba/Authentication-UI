...
public class ChannelActivity extends AppCompatActivity {
    ...
    String URL="https://www.googleapis.com/youtube/v3/playlists?part=snippet&channelId=UCBJycsmduvYEL83R_U4JriQ&key=AIzaSyD-89ulU8E-ZQkJFINGE2Dd5jiNjPWjCfQ";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myprofile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                myprofile.setClass(ChannelActivity.this, me.class);
                ...
                try {
                    ...
                    for(int i=0;i<jsonArray.length();i++){
                       ...
                       // JSONObject jsonVideoId=jsonObject1.getJSONObject("id");
                        String jsonVideoId=jsonObject1.getString("id");
